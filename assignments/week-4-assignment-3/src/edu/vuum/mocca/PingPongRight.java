...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore mPingpong[] = new SimpleSemaphore[2];
        ...
        public PlayPingPongThread(String stringToPrint,
        		...
        		SimpleSemaphore semaphoreTwo,
                                  int maxIterations) {
            // TODO - You fill in here.
        	mPingpong[FIRST_SEMA] = semaphoreOne;
        	mPingpong[SECOND_SEMA] = semaphoreTwo;
        ...
        private void acquire() {
            // TODO fill in here
        	mPingpong[FIRST_SEMA].acquireUninterruptibly();
        }
